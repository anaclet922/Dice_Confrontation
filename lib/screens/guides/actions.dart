        ...
        children: [
          ...
          Row(
            children: [
              Padding(
                ...
                child: Image.asset('assets/guide_action_1.png', width: 40,),
              ),
              const Expanded(
                child:  Text(
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_2.png', width: 40,),
              ),
              const Expanded(
                 child: Text(
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_3.png', width: 40,),
              ),
              const Expanded(
                child:  Text(
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_4.png', width: 40,),
              ),
              const Expanded(
                child: Text(
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_5.png', width: 40,),
              ),
              const Expanded(
                 child: Text(
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_6.png', width: 40,),
              ),
              const  Expanded(
                 child: Text(
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_7.png', width: 40,),
              ),
              const Expanded(
                 child: Text(
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_8.png', width: 40,),
              ),
              const Expanded(
                 child: Text(
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_9.png', width: 40,),
              ),
              const Expanded(
                 child: Text(
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_10.png', width: 40,),
              ),
              const Expanded(
                 child: Text(
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_11.png', width: 40,),
              ),
              const Expanded(
                 child: Text(
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_12.png', width: 40,),
              ),
              const Expanded(
                 child: Text(
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_13.png', width: 40,),
              ),
              const Expanded(
                 child: Text(
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_14.png', width: 40,),
              ),
              const Expanded(
                 child: Text(
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_15.png', width: 40,),
              ),
              const Expanded(
                 child: Text(
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_16.png', width: 40,),
              ),
              const Expanded(
                 child: Text(
                  'The player\'s life.',
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Image.asset('assets/guide_action_17.png', width: 40,),
              ),
              const Expanded(
                child:  Text(
